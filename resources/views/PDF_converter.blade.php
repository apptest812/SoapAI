    ...
    <div class="container text-center p-5 d-flex justify-content-center">
        <div class="card w-50 p-3">
            ...
            <form action="{{ route('convert.pdf') }}" method="post" enctype="multipart/form-data">
                ...
                <textarea name="text" class="form-control mt-3" id="jsonInput" cols="30" rows="4"></textarea>
                <button class="btn btn-primary mt-3" onclick="convertToJson()">Convert to PDF</button>
            </form>
